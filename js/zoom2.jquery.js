    ...
    $.fn.ZoomArea = function(options) {
        ...
        if (settings.externalIncrease) {
            $(settings.externalIncrease).bind("click", function(event) {
                ...
                zoom_c=zoom_c+1;
                if(zoom_c<10){
                	$('#group-marker-Ahemdabad').show();
					$('#group-marker-Surat').show();
					$('#group-marker-Pune').show();
					$('#group-marker-Mysuru').show();
					$('#group-marker-Kochi').show();
					$('#group-marker-Chennai').show();
                }else{
              	...
              	if(zoom_i<4){
            		...
            		$('#group-marker-Maharashtra').show();
            		$('#group-marker-Rajasthan').show();
            		$('#group-marker-Odisha').show();
            		$('#group-marker-Kashmir').show();
            		$('#group-marker-Kerala').show();
            		$('#group-marker-Karnataka').show();
            		$('#group-marker-andhra').show();
            		$('#group-marker-Telangana').show();
            		$('#group-marker-Chhattisgarh').show();
            		$('#group-marker-Bengal').show();
            		$('#group-marker-assam').show();
            		$('#group-marker-Bihar').show();
            		$('#group-marker-gujarat').show();
            		$('#group-marker-Tamil').show();
            		$('#group-marker-Uttarakhand').show();
            		$('#group-marker-Punjab').show();
            		$('#group-marker-Pradesh').show();
            		$('#group-marker-goa').show();
            	}else{
        ...
        function zooming(_element, _event, _delta) {
            ...
            //alert("mouse");
	            ...
	            settings.top = v_top1_2;
	             ...
	             //zoom_i=zoom_i+1;
	            // alert("left:"+settings.left);
	            // alert("top:"+settings.top);
	             if(previousZoomLevel<4){
                	$('#group-marker-Ahemdabad').show();
					$('#group-marker-Surat').show();
					$('#group-marker-Pune').show();
					$('#group-marker-Mysuru').show();
                 ...
                 if(previousZoomLevel>0 && previousZoomLevel<4){
                	$('#group-marker-Ahemdabad').show();
					$('#group-marker-Surat').show();
					$('#group-marker-Pune').show();
					$('#group-marker-Mysuru').show();
	            ...
	            if(previousZoomLevel>1 && previousZoomLevel<=2.3){
            		//alert("h"+zoom_i);
            		$('#group-marker-Maharashtra').show();
            		$('#group-marker-Rajasthan').show();
            		$('#group-marker-Odisha').show();
